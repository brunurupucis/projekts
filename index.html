...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Omifood is a premium food delivery service with the mission to bring affordble and healty meals to as many people as possible."> 
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-122943636-1"></script>
    <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());
    gtag('config', 'UA-122943636-1');
    </script>
