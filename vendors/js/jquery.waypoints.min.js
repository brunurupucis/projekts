...
n = o.newScroll > o.oldScroll,
 ...
 const a = this.waypoints[i][s]; if (a.triggerPoint !== null) {
 let l = o.oldScroll < a.triggerPoint, 
...
o = {}; this.handleScroll(), t = { horizontal: { contextOffset: e ? 0 : i.left, contextScroll: e ? 0 : this.oldScroll.x, contextDimension: this.innerWidth(), oldScroll: this.oldScroll.x, forward: 'right', backward: 'left', offsetProp: 'left' }, vertical: { contextOffset: e ? 0 : i.top, contextScroll: e ? 0 : this.oldScroll.y, contextDimension: this.innerHeight(), oldScroll: this.oldScroll.y, forward: 'down', backward: 'up', offsetProp: 'top' } }; for (const r in t) {
 const s = t[r]; for (const a in this.waypoints[r]) {
 var l, 
h, 
p, 
u, 
...
f = d.options.offset,
 w = d.triggerPoint,
 y = 0, 
g = w == null; d.element !== d.element.window && (y = d.adapter.offset()[s.offsetProp]), typeof f === 'function' ? f = f.apply(d) : typeof f === 'string' && (f = parseFloat(f), d.options.offset.indexOf('%') > -1 && (f = Math.ceil(s.contextDimension * f / 100))), l = s.contextScroll - s.contextOffset, d.triggerPoint = Math.floor(y + l - f), h = w < s.oldScroll, p = d.triggerPoint >= s.oldScroll, u = h && p, c = !h && !p, !g && u ? (d.queueTrigger(s.backward), o[d.group.id] = d.group) : !g && c ? (d.queueTrigger(s.forward), o[d.group.id] = d.group) : g && s.oldScroll >= d.triggerPoint && (d.queueTrigger(s.forward), o[d.group.id] = d.group); 
} 
} return n.requestAnimationFrame(() => { for (const t in o)o[t].flushTriggers(); }), this; 
 ...
 'use strict'; function t(t, e) { return t.triggerPoint - e.triggerPoint; } function e(t, e) { return e.triggerPoint - t.triggerPoint; } function i(t) { this.name = t.name, this.axis = t.axis, this.id = `${this.name}-${this.axis}`, this.waypoints = [], this.clearTriggerQueues(), o[this.axis][this.name] = this; } var o = { vertical: {}, horizontal: {} }, 
...
o = i === this.waypoints.length - 1; return o ? null : this.waypoints[i + 1]; 
 ...
 'use strict'; function t(t) { this.$element = e(t); } var e = window.jQuery, 
